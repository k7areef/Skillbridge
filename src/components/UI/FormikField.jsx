...
function FormikField({ setFieldValue, label, typeField, icon, parentClassName, options, ...props }) {
    ...
    const sharedStyles = `w-full p-3 bg-white-99 border border-white-95 rounded-md transition duration-300 ease-in-out read-only:border-transparent not-read-only:focus:border-orange-50 placeholder:text-grey-40`;
