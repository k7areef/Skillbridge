...
- Frontend Framework: [React 19](https://react.dev/) (latest version).
- Build Tool: [Vite 7](https://vite.dev/) for ultra-fast development.
- Styling: [TailwindCSS](https://tailwindcss.com/) v4 (using the new Vite plugin).
- Routing: [React Router 7](https://reactrouter.com/).
- Forms & Validation: [Formik & Yup](https://formik.org/).
- Icons: FontAwesome.
- Deployment Ready: Configured for [Vercel](https://vercel.com/).
...
Project Link: [github.com](https://github.com/k7areef/Skillbridge)
